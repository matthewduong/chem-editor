...
export const CANVAS_TOOL_SHORTCUTS: CanvasToolShortcut[] = [
  ...
  },
  {
    ...
    description: 'Switch to the solid bond tool when no canvas object is hovered.',
    category: 'Tools',
    context: 'canvas',
  ...
  },
  {
    ...
    description: 'Switch to the text tool when no canvas object is hovered.',
    category: 'Tools',
    context: 'canvas',
  ...
  },
  {
    ...
    description: 'Switch to the arrow tool when no canvas object is hovered.',
    category: 'Tools',
    context: 'canvas',
  ...
  },
  {
    ...
    description: 'Switch to the cyclopentadiene fragment tool when no canvas object is hovered.',
    category: 'Tools',
    context: 'canvas',
  ...
  },
  {
    ...
    description: 'Switch to the cyclohexane fragment tool when no canvas object is hovered.',
    category: 'Tools',
    context: 'canvas',
  ...
  },
  {
    ...
    description: 'Switch to the cyclopentane fragment tool when no canvas object is hovered.',
    category: 'Tools',
    context: 'canvas',
...
export function getCanvasToolShortcut(
  preferences: KeybindingPreferences | undefined,
  event: KeyboardEvent,
  options: { hasHoveredObject?: boolean; hasHoveredAtomOrBond?: boolean } = {},
): CanvasToolShortcut | null {
  if (options.hasHoveredObject || options.hasHoveredAtomOrBond) return null;
  return (
